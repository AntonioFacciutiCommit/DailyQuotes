document.addEventListener("DOMContentLoaded", function() {
    ...
    function displayQuotes() {
        ...
        quotesToDisplay.forEach((quote, index) => addQuoteToList(quote.text, quote.author, index + startIndex));
        updatePagination();
    }
    ...
    function displayFavoriteQuotes() {
        ...
        favoriteQuotes.forEach(quote => addFavoriteQuoteToList(quote.text, quote.author));
    }
